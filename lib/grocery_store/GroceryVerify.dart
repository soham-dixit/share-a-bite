...
class GroceryVerify extends StatefulWidget {
  final String name;
  final String email;
...
class _GroceryVerifyState extends State<GroceryVerify> {
  String code = "";
...
class GroceryVerify2 extends StatefulWidget {
  final String name;
  final String email;
  final String address;
  final String license;
...
class _GroceryVerify2State extends State<GroceryVerify2> {
  String code = "";
