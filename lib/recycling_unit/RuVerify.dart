...
class RuVerify extends StatefulWidget {
  final String name;
  final String email;
  ...
  @override
  State<RuVerify> createState() => _RuVerifyState();
}

class _RuVerifyState extends State<RuVerify> {
  String code = "";
...
class RuVerify2 extends StatefulWidget {
  final String name;
  final String email;
  final String address;
  final String license;
  ...
  @override
  State<RuVerify2> createState() => _RuVerify2State();
}

class _RuVerify2State extends State<RuVerify2> {
  String code = "";
  ...
  saveInfo() async {
    ...
    final uid = user.uid;
    databaseReference.child("recycling_units").child(uid).set({
      'name': widget.name,
      'email': widget.email,
      'address': widget.address,
      'license': widget.license,
